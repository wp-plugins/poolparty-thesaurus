...
unitipize = function (element) {
	...
	if (span != null) {
		...
		var sTitle = (altText == true) ? a.getAttribute("alt") : span.innerHTML;				
		if(sTitle) {
			a.onmouseover = function() {unitipBuild(a, sTitle);};
			a.onmouseout = function() {unitipHide(a, sTitle);};
		}
	}
}

// now, we build the tooltip
unitipBuild = function (a, sTitle) {
	...
	document.onmousemove = function (evt) {unitipMove (evt)};
}

// now, we track the mouse and make the tooltip follow
unitipMove = function (evt) {
